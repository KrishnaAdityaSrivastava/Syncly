            ...
            <div className="space-y-8">
              ...
              >
                <span className={`inline-flex items-center rounded-full border px-4 py-2 text-sm ${darkMode ? "border-blue-400/20 bg-blue-500/10 text-blue-200" : "border-blue-200 bg-blue-50 text-blue-700"}`}>
                  Modern workspace, consistent with the app you’ll use daily
                </span>
                <h1 className="max-w-3xl text-5xl font-semibold leading-tight md:text-6xl">
                  Keep projects, tasks, and team updates moving in one
                ...
                <p className={`max-w-2xl text-lg leading-8 ${mutedText}`}>
                  Syncly brings together planning, status tracking, direct communication, and reporting with a clean dashboard-first experience that feels consistent from landing page to delivery workflow.
                </p>
              </motion.div>
              ...
              <div className={`rounded-[1.5rem] border p-5 ${darkMode ? "border-white/10 bg-gray-950/80" : "border-slate-200 bg-white"}`}>
                ...
                <div className="mt-6 rounded-3xl border border-blue-500/15 p-5">
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      <p className="font-medium">Weekly delivery summary</p>
                      <p className={`mt-1 text-sm ${mutedText}`}>A look that mirrors the product’s dashboard cards and clean reporting tone.</p>
                    </div>
