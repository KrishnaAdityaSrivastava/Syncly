...
const Reports = () => {
  ...
  const roleStats = useMemo(() => {
    ...
    return [
      { label: "Admin", value: counts.admin || 0 },
      { label: "Member", value: counts.member || 0 },
      { label: "Viewer", value: counts.viewer || 0 }
    ];
  }, [projects]);
              ...
              {[
                ...
                return (
                  <div key={label} className="space-y-2">
                    ...
                    <div className={`h-2 rounded-full ${darkMode ? "bg-gray-900" : "bg-slate-100"}`}>
